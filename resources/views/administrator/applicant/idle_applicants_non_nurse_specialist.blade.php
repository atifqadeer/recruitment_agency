      ...
      $(document).ready(function() {
        $.fn.dataTable.ext.errMode = 'none';
          ...
          $('#applicant_sample_2').DataTable({
               ...
               "serverSide": true,
               "responsive": true,
               "ajax":"getIdleApplicantsNonNurseSpecialist",
               "order": [],
               "columns": new_columns
          });
        ...
        <div class="content">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('export_idel_applicants_specialist') }}" class="btn bg-slate-800 legitRipple float-right" style="margin-right:20px;">
