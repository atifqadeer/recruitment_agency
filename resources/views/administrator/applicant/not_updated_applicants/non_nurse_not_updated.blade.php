    ...
    // columns.push({ "data":"applicant_notes", "name": "applicant_notes" });
      $(document).ready(function() {
        $.fn.dataTable.ext.errMode = 'none';
          ...
          <?php endif; ?>
          $('#non_nurse_not_updated_table').DataTable({
              
               "processing": true,
               "serverSide": true,
               "responsive": true,
               "ajax":"get_non_nurse_not_updated_app",
               "order": [],
               "columns": columns,
               lengthMenu: [
            [10, 25, 50, 100, 500, -1],
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Non Nurse Not Updated Applicants</span> - All
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Non Nurse Not Updated Applicants</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Non Nurse Not Updated Applicants</h5>
                </div>
                ...
                <table class="table table-hover table-striped" id="non_nurse_not_updated_table">
                    <thead>
                    <tr>
                        <th>Date</th>
                        <th>Time</th>
