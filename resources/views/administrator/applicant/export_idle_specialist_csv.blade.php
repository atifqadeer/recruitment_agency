            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Idle Applicants</span>
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="{{ route('users.index') }}" class="breadcrumb-item">Idle Specialist Applicants</a>
                ...
                <div class="col-md-5">
                    <div class="card border-top-teal-400 border-top-3">
                            ...
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    <div class="header-elements-inline">
                                        <h5 class="card-title">Export Idle Applicants</h5>
                                        <a href="{{ route('idle_applicants') }}" class="btn bg-slate-800 legitRipple">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    {{ Form::open(array('route' => 'idle_applicants_export','method' => 'POST' )) }}
                                    <div class="list-icons">
                                        ...
                                        <span class="add-on">
                                          <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                            ...
                                            <input data-format="dd-MM-yyyy" type="text" name="start_date" id="start_date" required>
                                        </div>
                                        <b>To: </b>
                                        ...
                                        <span class="add-on">
                                          <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                            ...
                                            <input data-format="dd-MM-yyyy" type="text" name="end_date" id="end_date" required> 
                                        </div>
                                        <a class="list-icons-item" data-action="reload"></a>
                                    </div>
                                    <div class="form-group">
                                    {{ Form::label('roles','Job Category') }}
                                    <select class="form-control form-control-select2" id="selectUser" name="user_selected" required >
                                            <option value="0" selected>Please select job category</option>  
                                            <option value="44">Nurse</option>
                                            <option value="45">Non-Nurse</option>
                                            <option value="46" selected="true">Specialist</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    <select class="form-control form-control-select2" id="radius" name="radius" required >
                                            <option value="0" selected>Please select radius</option>  
                                    ...
                                    <div class="text-right">
                                        <!-- {{ Form::button('Export <i class="icon-paperplane ml-2"></i>',['type'=>'button','id'=>'testing_pre','class'=>'btn bg-teal legitRipple','id'=>'download_file']) }} -->
...
//        $.ajax({                     
//             url: "{{ route('idle_applicants_export') }}",
//             method: "POST",
//             cache: false,
//             data: {
//                 start_date,
