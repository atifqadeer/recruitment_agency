                ...
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    <div class="header-elements-inline">
                                        <h5 class="card-title">Edit an IP Address</h5>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    {{ Form::open(array('route'=>['ip-addresses.update',$ip_address->id],'method'=>'patch')) }}

                                    <div class="form-group">
                                        {{ Form::label('ip_address','IP Address') }}
                                        {{ Form::text('ip_address',$ip_address->ip_address,array('class'=>'form-control','id'=>'ip_address', 'required')) }}
                                    </div>
