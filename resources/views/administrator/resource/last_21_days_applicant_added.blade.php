            ...
            <div class="card">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="all_resources">
                        <table class="table table-hover table-striped table-responsive" id="all_resources_table">
                            <thead>
                            <tr>
                                <th>Date</th>
                                <th>Time</th>
                    ...
                    <div class="tab-pane" id="not_interested_resources">
                        <table class="table table-hover table-striped table-responsive" id="not_interested_resources_table">
                            <thead>
                            <tr>
                                <th>Date</th>
                                <th>Time</th>
                    ...
                    <div class="tab-pane" id="blocked_resources">
                        <table class="table table-hover table-striped table-responsive" id="blocked_resources_table">
                            <thead>
                            <tr>
                                <th>Date</th>
                                <th>Time</th>
