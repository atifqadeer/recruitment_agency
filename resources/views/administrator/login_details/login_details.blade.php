...
{{--        <div class="page-header page-header-dark has-cover" style="border: 1px solid #ddd; border-bottom: 0;">--}}
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Login</span> - Details
                    </h5>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="card border-top-teal-400 border-top-3">
                ...
                <table class="table table-hover table-striped" id="user_login_details">
                    <thead>
                    <tr>
                        <th>User#</th>
                        <th>Name</th>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->name }}</td>
                        <td>{{ $user->email }}</td>
                        <td>{{date("g:i A", strtotime($user->max_time))}}</td>
