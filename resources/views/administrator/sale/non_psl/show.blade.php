            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">All Units</span> - Non PSL
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Non PSL Clients Units</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Active Non PSL Clients Units</h5>
                </div>
                ...
                <table class="table datatable-sorting">
                    ...
                    @foreach($units as $unit)
                        <tr >
                            ...
                            <td>
                                <a data-toggle="collapse" data-target="#unitName{{$unit->id}}"
                                   href="#"
