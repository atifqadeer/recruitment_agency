    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        $.fn.dataTable.ext.errMode = 'none';
          $('#nursing_sample_1_old').DataTable({
        ...
        $.fn.dataTable.ext.errMode = 'none';
          $('#nursing_sample_1').DataTable({
               ...
               // "aaSorting": [[0, "desc"]],
               // "sPaginationType": "full_numbers",
               "sAjaxSource": "{{ url('/get-region-nurses-sales_test/'.$id.'/'.$category) }}",
               {{--"sAjaxSource": "{{ url('/get-region-nurses-sales/'.$id.'/'.$category) }}",--}}
            ...
            "render": function (data, type, row) {
                return '<a href="/applicants-within-15-km/' + row.id + '">' + data + '</a>';
            }
        },
                  ...
                  { "data": "sale_note" } // Column 11: sale_note
              ],
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Active Sales
                    @if($category=='44')
                        - Nurses</h5>
                    @else
                        - Non-nurses
