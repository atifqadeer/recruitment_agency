<div class="content-wrapper">
    <div class="content">
        <table class="table datatable-sorting">
            ...
            <tbody>
            @foreach($start_date_hold as $applicant)
                <tr>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('processCv') }}"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="start_date_hold_to_start_date" value="start_date_hold_to_start_date"
                                            class="btn bg-dark legitRipple">start date
                                    </button>
                                    <button type="submit" name="start_date_hold_save" value="start_date_hold_save" class="btn bg-teal legitRipple">
                                        Save
                                    </button>
                                </div>
                            </form>
