<div class="content-wrapper">
    <div class="content">
        <table class="table datatable-sorting">
            ...
            <tbody>
            @foreach($applicant_with_rejected_cvs as $applicant)
                <tr>
                    ...
                    <td><b>DATE:</b>{{ $applicant->crm_added_date }} <b>TIME:</b>{{ $applicant->crm_added_time }} <b>NOTE:</b>{{ $applicant->details }}</td>
                    <td>
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="#" class="dropdown-item"
                                       data-controls-modal="#revert_to_sent_cvs{{ $applicant->id }}-{{ $applicant->sale_id }}" data-backdrop="static"
                                       data-keyboard="false" data-toggle="modal"
                                       data-target="#revert_to_sent_cvs{{ $applicant->id }}-{{ $applicant->sale_id }}">
                ...
                <div id="revert_to_sent_cvs{{ $applicant->id }}-{{ $applicant->sale_id }}" class="modal fade" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('processCv') }}"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="rejected_cv_revert_to_sent_cvs" value="rejected_cv_revert_to_sent_cvs"
