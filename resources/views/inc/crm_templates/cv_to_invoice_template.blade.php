                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('processCv') }}"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="paid" value="paid"
                                            class="btn bg-orange-800 legitRipple">Paid
                                    </button>
                                    <button type="submit" name="dispute" value="dispute"
                                            class="btn bg-dark legitRipple">dispute
                                    </button>
                                    <button type="submit" name="final_save" value="final_save" class="btn bg-teal legitRipple">
                                        Save
                                    </button>
                                </div>
                            </form>
