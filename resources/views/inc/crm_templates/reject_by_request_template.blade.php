<div class="content-wrapper">
    <div class="content">
        <table class="table datatable-sorting">
            ...
            <tbody>
            @foreach($reject_by_request as $applicant)
                <tr>
                    ...
                    <td><b>DATE:</b>{{ $applicant->crm_added_date }}<br>
                        <b>TIME:</b>{{ $applicant->crm_added_time }}<br>
                        <b>NOTE:</b>{{ $applicant->details }}</td>
                    <td>
...
{{--                                    <a href="{{ route('revertCv',['id'=>$applicant->id , 'viewString'=>'applicantWithRejectByRequestCv']) }}"--}}
{{--                                       class="dropdown-item"><i class="icon-file-confirm"></i> Revert</a>--}}
                ...
                <div id="revert{{ $applicant->id }}-{{ $applicant->sale_id }}" class="modal fade" tabindex="-1">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('processCv') }}"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="rejected_request_revert_to_sent_cvs" value="rejected_request_revert_to_sent_cvs"
                                            class="btn bg-dark legitRipple"> Sent CV
                                    </button>
                                    <button type="submit" name="rejected_request_revert_to_request" value="rejected_request_revert_to_request"
                                            class="btn bg-teal legitRipple"> Request
                                    </button>
                                </div>
                            </form>
                        </div>
