...
{{--                                        @php($x=1)--}}
                                ...
                                @endforeach
{{--                                @if($x==0)--}}
{{--                                    <p><b>DATE:</b> {{ $applicant->quality_added_date}}</p>--}}
{{--                                    <p><b>TIME</b> {{ $applicant->quality_added_time }}</p>--}}
...
{{--                                <p><b>NOTE:</b> {{ $applicant->details }}</p>--}}
                    ...
                    <!-- Move CV Modal -->
                    <div id="clear_cv{{ $applicant->id }}-{{ $applicant->sale_id }}" class="modal fade" tabindex="-1">
