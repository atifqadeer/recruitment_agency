<div class="content-wrapper">
    <div class="content">
        <table class="table datatable-sorting">
            ...
            <tbody>
            @foreach($start_date as $applicant)
                <tr>
...
{{--                                        @if(($crm_save ->app_id == $applicant->id) && ($x==0))--}}
                                        @if(($crm_save->app_id == $applicant->id) && ($crm_save->sales_id == $applicant->sale_id))
                                            <p><b>DATE:</b> {{ $crm_save->crm_added_date}}</p>
                                            <p><b>TIME</b> {{ $crm_save->crm_added_time }}</p>
                                            <p><b>NOTE:</b> {{ $crm_save->crm_note_details }}</p>
{{--                                            @php($x=1)--}}
                                        @break
                                        @endif
...
{{--                            <p><b>NOTE:</b> {{ $applicant->details }}</p>--}}
                ...
                <div id="after_interview{{ $applicant->id }}-{{$applicant->sale_id}}" class="modal fade" tabindex="-1">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('processCv') }}"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="start_date_invoice" value="start_date_invoice"
                                            class="btn bg-orange-800 legitRipple">invoice
                                    </button>
                                    <button type="submit" name="start_date_hold" value="start_date_hold"
                                            class="btn bg-dark legitRipple">start date hold
                                    </button>
                                    <button type="submit" name="start_date_save" value="start_date_save" class="btn bg-teal legitRipple">
                                        Save
                                    </button>
                                </div>
                            </form>
