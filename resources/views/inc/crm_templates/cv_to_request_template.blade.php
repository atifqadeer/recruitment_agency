...
{{--                            <p><b>NOTE:</b> {{ $applicant->details }}</p>--}}
                ...
                <div id="confirm_cv{{ $applicant->id }}-{{ $applicant->sale_id }}" class="modal fade" tabindex="-1">
                            ...
                            <form action="{{ route('processCv') }}"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="request_to_confirm" value="request_to_confirm"
                                            {{ $disabled }}
                                            class="btn bg-dark legitRipple">Confirm
                                    </button>
                ...
                <div id="schedule_interview{{ $applicant->id }}-{{ $applicant->sale_id }}" class="modal fade" tabindex="-1">
...
{{--                                    <input type="hidden" name="sale_id" value="{{ $sale->id }}">--}}
                                    <input type="hidden" name="sale_id" value="{{ $applicant->sale_id }}">
                                    <div class="mb-4">
