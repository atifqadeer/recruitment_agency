...
{{--                            <p><b>NOTE:</b> {{ $applicant->details }}</p>--}}
                ...
                <!-- Accept Modal -->
                <div id="accept{{ $applicant->id }}-{{ $applicant->sale_id }}" class="modal fade" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Start Date Notes</h5>
                            ...
                            <form action="{{ route('processCv') }}"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="start_date" value="start_date"
                                            class="btn bg-orange-800 legitRipple">Start Date
                                    </button>
                                    <button type="submit" name="prestart_save" value="prestart_save"
                                            class="btn bg-dark legitRipple">Save
                                    </button>
                                </div>
                            </form>
                        </div>
