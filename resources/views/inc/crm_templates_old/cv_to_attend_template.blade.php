        ...
        <table class="table datatable-sorting">
            ...
            @foreach($attended as $applicant)
                <tr>
                    ...
                    <td>@if(empty($crm_attend_save_note->details))
                            {{
                            $applicant->details
                            }}
                        @else
                            {{
                            $crm_attend_save_note->details
                             }}
                        @endif</td>
                    <td>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="#" class="dropdown-item"
                                       data-controls-modal="#accept{{ $applicant->id }}" data-backdrop="static"
                                       data-keyboard="false" data-toggle="modal"
                                       data-target="#accept{{ $applicant->id }}">
                ...
                <!-- Accept Modal -->
                <div id="accept{{ $applicant->id }}" class="modal fade" tabindex="-1">
