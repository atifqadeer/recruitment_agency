    ...
    <div class="content">
        <table class="table datatable-sorting">
            ...
            @foreach($not_attended as $applicant)
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="#" data-controls-modal="#manager_details{{ $applicant->id }}"
                                       data-backdrop="static"
                                       data-keyboard="false" data-toggle="modal"
                                       data-target="#manager_details{{ $applicant->id }}"
                                       class="dropdown-item"><i class="icon-file-confirm"></i> Manager Details</a>
                                    <a href="#" class="dropdown-item"
                                       data-controls-modal="#revert_to_attended{{ $applicant->id }}" data-backdrop="static"
                                       data-keyboard="false" data-toggle="modal"
                                       data-target="#revert_to_attended{{ $applicant->id }}">
                ...
                <div id="revert_to_attended{{ $applicant->id }}" class="modal fade" tabindex="-1">
